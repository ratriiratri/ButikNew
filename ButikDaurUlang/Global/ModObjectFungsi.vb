Module ModObjectFungsi
    Public EntitasUser As New EntityUser
    Public KontrolUser As New ControlUser

    Public EntitasProduk As New EntityProduk
    Public KontrolProduk As New ControlProduk
