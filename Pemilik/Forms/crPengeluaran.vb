...
Public Class crPengeluaran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pemilik.crPengeluaran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPengeluaran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPengeluaran = New crPengeluaran()
        rpt.Site = Me.Site
        Return rpt
    End Function
